            ...
            {!success ? (
              ...
              <div className="space-y-6 text-center">
                ...
                <div className="space-y-3">
                  <Link
                    to="/login"
                    className="inline-flex h-11 w-full items-center justify-center rounded-lg bg-[#FFB800] px-6 font-medium text-white transition-colors hover:bg-[#FFA000] focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 sm:h-12 sm:text-base">
                    로그인하기
                  </Link>
                  <Link
                    to="/find-password"
